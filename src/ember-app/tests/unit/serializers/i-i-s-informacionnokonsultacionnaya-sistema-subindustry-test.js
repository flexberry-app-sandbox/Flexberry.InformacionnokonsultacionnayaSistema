...
moduleForModel('i-i-s-informacionnokonsultacionnaya-sistema-subindustry', 'Unit | Serializer | i-i-s-informacionnokonsultacionnaya-sistema-subindustry', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-informacionnokonsultacionnaya-sistema-subindustry',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

...
moduleForModel('i-i-s-informacionnokonsultacionnaya-sistema-list-size', 'Unit | Serializer | i-i-s-informacionnokonsultacionnaya-sistema-list-size', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-informacionnokonsultacionnaya-sistema-list-size',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

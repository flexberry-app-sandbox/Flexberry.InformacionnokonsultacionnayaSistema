...
moduleForModel('i-i-s-informacionnokonsultacionnaya-sistema-support', 'Unit | Serializer | i-i-s-informacionnokonsultacionnaya-sistema-support', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-informacionnokonsultacionnaya-sistema-support',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

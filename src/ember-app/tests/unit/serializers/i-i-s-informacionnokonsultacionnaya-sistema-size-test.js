...
moduleForModel('i-i-s-informacionnokonsultacionnaya-sistema-size', 'Unit | Serializer | i-i-s-informacionnokonsultacionnaya-sistema-size', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-informacionnokonsultacionnaya-sistema-size',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

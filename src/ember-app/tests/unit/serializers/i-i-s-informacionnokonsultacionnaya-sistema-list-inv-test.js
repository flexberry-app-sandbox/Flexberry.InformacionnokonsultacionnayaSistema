...
moduleForModel('i-i-s-informacionnokonsultacionnaya-sistema-list-inv', 'Unit | Serializer | i-i-s-informacionnokonsultacionnaya-sistema-list-inv', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-informacionnokonsultacionnaya-sistema-list-inv',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

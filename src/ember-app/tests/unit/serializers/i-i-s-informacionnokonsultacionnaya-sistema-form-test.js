...
moduleForModel('i-i-s-informacionnokonsultacionnaya-sistema-form', 'Unit | Serializer | i-i-s-informacionnokonsultacionnaya-sistema-form', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-informacionnokonsultacionnaya-sistema-form',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

...
moduleForModel('i-i-s-informacionnokonsultacionnaya-sistema-investment', 'Unit | Serializer | i-i-s-informacionnokonsultacionnaya-sistema-investment', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-informacionnokonsultacionnaya-sistema-investment',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

...
moduleForModel('i-i-s-informacionnokonsultacionnaya-sistema-component', 'Unit | Serializer | i-i-s-informacionnokonsultacionnaya-sistema-component', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-informacionnokonsultacionnaya-sistema-component',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

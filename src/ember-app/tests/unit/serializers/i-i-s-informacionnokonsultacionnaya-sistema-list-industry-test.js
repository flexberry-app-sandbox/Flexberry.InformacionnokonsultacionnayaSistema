...
moduleForModel('i-i-s-informacionnokonsultacionnaya-sistema-list-industry', 'Unit | Serializer | i-i-s-informacionnokonsultacionnaya-sistema-list-industry', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-informacionnokonsultacionnaya-sistema-list-industry',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

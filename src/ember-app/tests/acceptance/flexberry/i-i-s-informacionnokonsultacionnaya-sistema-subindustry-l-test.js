...
moduleForAcceptance('[AGAT] Acceptance | i i s informacionnokonsultacionnaya sistema subindustry l');

test('testing i-i-s-informacionnokonsultacionnaya-sistema-subindustry-l', function(assert) {

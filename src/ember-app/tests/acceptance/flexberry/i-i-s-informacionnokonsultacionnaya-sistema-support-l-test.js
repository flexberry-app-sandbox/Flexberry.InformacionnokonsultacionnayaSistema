...
moduleForAcceptance('[AGAT] Acceptance | i i s informacionnokonsultacionnaya sistema support l');

test('testing i-i-s-informacionnokonsultacionnaya-sistema-support-l', function(assert) {

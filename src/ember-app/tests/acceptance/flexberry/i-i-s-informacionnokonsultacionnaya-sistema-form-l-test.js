...
moduleForAcceptance('[AGAT] Acceptance | i i s informacionnokonsultacionnaya sistema form l');

test('testing i-i-s-informacionnokonsultacionnaya-sistema-form-l', function(assert) {

...
moduleForAcceptance('[AGAT] Acceptance | i i s informacionnokonsultacionnaya sistema size l');

test('testing i-i-s-informacionnokonsultacionnaya-sistema-size-l', function(assert) {

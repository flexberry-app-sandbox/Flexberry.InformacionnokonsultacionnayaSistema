...
moduleForAcceptance('[AGAT] Acceptance | i i s informacionnokonsultacionnaya sistema component l');

test('testing i-i-s-informacionnokonsultacionnaya-sistema-component-l', function(assert) {

...
moduleForAcceptance('[AGAT] Acceptance | i i s informacionnokonsultacionnaya sistema investment l');

test('testing i-i-s-informacionnokonsultacionnaya-sistema-investment-l', function(assert) {
